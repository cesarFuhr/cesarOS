...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        /**/ _______, XXXXXXX, KC_GRV, S(KC_GRV), XXXXXXX, XXXXXXX, /*              */ XXXXXXX, XXXXXXX, _______, _______, _______, _______,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
        /*                           */ KC_LALT, LT(2, KC_ESC), KC_LGUI, /* */ LT(3, KC_ENT), LT(1, KC_SPC), KC_RCTL
        //                                    `--------------------------'   `--------------------------'
        ),
    ...
    [2] = LAYOUT_split_3x6_3(
        //,------------------------------------------------------.                    ,-----------------------------------------------------.
        /**/ _______, XXXXXXX, XXXXXXX, S(KC_LBRC), S(KC_RBRC), XXXXXXX,/*          */ KC_HOME, KC_PGDN, KC_RGHT,   KC_END, KC_EQL, KC_BSPC,
        //|----------+-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        /**/ _______, XXXXXXX, KC_PSCR, KC_LBRC, KC_RBRC, XXXXXXX,/*                 */KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, KC_MINS, KC_BSLS,
        //|----------+-------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
    ...
    [3] = LAYOUT_split_3x6_3(
        ...
        //|---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        /**/ _______, KC_VOLU, KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT, /*               */ KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, XXXXXXX, KC_BSLS,
        //|---------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
